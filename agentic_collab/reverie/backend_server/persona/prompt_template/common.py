...
config_path = Path("../../openai_config.json") #changed this to run the model
#config_path = Path("/Users/josephkambeitz/Desktop/Research/simulacra/agentic_collab/reverie/backend_server/openai_config.json")

print("Absolute path being used:", os.path.abspath(config_path))
